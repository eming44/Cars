const cars =  [
    ...
    { id: 0, url: 'audia3.jpg', 
    baseSpecs: { manufacturer: "Audi", model: "A3", modification: "35 TFSI", generation: "8Y", releaseDate: 2020, fuelConsumption: "4.7-4.9", maximumSpeed: 232, acceleration: 8.4, weight: 1320 }, 
    engineSpecs: { horsePower: 150, engineDisplacement: 1498, fuelType: "petrol", cilindersNumber: 4, torque: 250 }, 
    transmissionSpecs: {  transmission: "Automatic", gears: 7 }, 
    brakeWheelSpecs: { frontDiscType: "Ventilated", rareDiscType: "Disc", frontDiscMaterial: "Cast iron", rareDiscMaterial: "Cast iron", frontPadsMaterial: "Organic", rarePadsMaterial: "Organic"}, 
    description: "Audi A3 2020 1.5 TFSI is being produced from January, 2020. It has four-cylinder petrol engine with displacement of 1.5 litres, which produces power of 150 horsepower on 5000 rpm - this is the most powerfull Audi A3 2020 version and torque 250 Nm (Newton metres) on 1500 revolutions per minute.", 
    interiorImageUrls: ["audia3int.jpg", "audia3int1.jpg", "audia3int2.jpg", "audia3int3.jpg",] },
